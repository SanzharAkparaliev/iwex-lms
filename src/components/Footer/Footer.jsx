   ...
   <footer className={styled.site_footer}>
       ...
       <div className={styled.roww}>
        ...
        <div className={styled.icon_footer}>
          <a href="https://www.facebook.com/iwex.kg/?locale=ru_RU"><FaFacebook className={styled.icon_fac}/></a>
          <a href=""><RiTwitterFill className={styled.icon_twitt}/></a>
          <a href=" https://kg.linkedin.com/in/team-iwex-93ba0624b?original_referer=https%3A%2F%2Fwww.google.com%2F"><RxLinkedinLogo className={styled.icon_link}/></a>
          <a href="https://www.instagram.com/iwex.kg/"><RiInstagramFill className={styled.icon_inst}/></a>
