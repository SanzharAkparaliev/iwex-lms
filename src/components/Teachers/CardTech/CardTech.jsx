...
export const CardTech = ({key, title, prof, opi, imgg, twitt, insta, link, fack}) => {
    ...
    <div className={styled.card} id={key}>
        ...
        <div className={styled.card_text}>
            ...
            <div className={styled.icon}>
                <a href={fack} ><FaFacebook  className={styled.card_fac}/></a>
                <a href={link}><RxLinkedinLogo className={styled.card_link}/></a>
